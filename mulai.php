...
<div class="group hidden-xs">
    <div class="left hidden-xs" style="background-color:<?php echo "$r[XWarna]"; ?>"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-top:10px;width:350px"></a>

    </div>
    	<div class="right"><table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">   
     					<tr class="hidden-xs"><td rowspan="3" width="100px" align="center"><img src="fotosiswa/<?php echo "$gambar"; ?>" style=" margin-left:0px; margin-top:5px" class="foto"></td>
...
<div class="grup" style="width:90%; margin:0 auto; margin-top:50px">
<div class="kiri">
            <form action="puspendik.php" method="post">    

                        
                            <div class="list-group-item top-heading">
                                <h1 class="list-group-item-heading page-label">Konfirmasi Data </h1>
                            </div>
                           ...
                           <p class="list-group-item-text"><?php echo "$xjumlahsoal"; ?> Nomor Soal</p>
                           <input id="Gender" name="Gender" type="hidden" value="Pria">
                           </div>
