...
<div class="group hidden-xs">
    <div class="left" style="background-color:<?php echo "$r[XWarna]"; ?>"><img  src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-top:10px; width:350px"></a>
    </div>
    	<div class="right "><table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">   
						...
						<td><span class="hidden-xs" style=" margin-left:0px; margin-top:5px">Selamat Datang</span></td></tr>
                        <tr><td><span class="user"><?php echo "$val_siswa ($xkodekelas)"; ?></span></td></tr>
                         <tr><td><span class="log"><a href="logout.php"><font color="yellow">Logout</font></a><span></td></tr>
						</table>
...
<nav style="background-color:<?php echo "$r[XWarna]"; ?>; border:0px; max-height:100px" class="navbar navbar-default visible-xs">
  <div class="container-fluid">
    <div class="navbar-header">
      <div class="col-xs-3">
       <img src="fotosiswa/<?php echo "$gambar"; ?>" style="height:60px">
      </div>
	   <div class="col-xs-9">
	   <span class="user"><font size="2"><?php echo "$val_siswa ($xkodekelas)"; ?></font></span><br>
       <span class="log"><a href="logout.php"><font color="yellow">Logout</font></a><span>
      </div>
    </div>
...
<form action="mulai.php" method="post">    
                ...
                <div class="list-group-item">
                    <label class="list-group-item-heading">Nomor Ujian Peserta</label>
...
?>
<?php
 $sqlcekujian = mysql_num_rows(mysql_query("SELECT * FROM cbt_ujian where(XKodeKelas = '$xkelz' or XKodeKelas = 'ALL') and (XKodeJurusan = '$xjurz' or XKodeJurusan = 'ALL') and XStatusUjian = '1' and XSesi =  '$xsesi' or XSesi =  '1' or XSesi =  '2' or XSesi =  '3' or XSesi =  '4' or XSesi =  '5'"));
if($sqlcekujian>0){ ?>
		...
		?>                
                <div class="list-group-item">
                    <label class="list-group-item-heading">Token Anda <?php // echo "$jumsis = $ada"; ?></label> <?php echo "$xtokenujian"; ?>
                ...
                <div class="list-group-item">
                    <div class="row">
                        <div class="col-xs-push-8 col-xs-4"><br>
...
<div style="margin-top:130px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
    <div class="content hidden-xs">
     <marquee>Jika mengalami kesulitan silakan menghubungi proktor!</marquee>
   </div>
</div>
      <!-- Modal -->
...
<footer>
    <div class="container" style=" font-size:12px">
        <p><?php echo strtoupper("$r[XSekolah]"); ?> | Computer Base Test</p>
    </div>
</footer>
