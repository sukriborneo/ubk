...
<script>
   ...
   setTimeout(function(){
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>CBT HSA | UJIAN ONLINE</title>
...
<div class="group hidden-xs">
    <div class="left hidden-xs" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="#"><img class="hidden-xs"  src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-top:10px;width:350px"></a>
    </div>
    	<div class="right1"><table width="100%" border="0" cellspacing="5px;" style="margin-top:10px">   
     					<tr><td rowspan="3" width="100px" align="center"><img src="fotosiswa/<?php echo "$gambar"; ?>" style=" margin-left:0px; margin-top:5px" class="foto hidden-xs"></td>
...
<!-- asli            <span class="flex-item" style="background-color:<?php echo $cssb; ?>"  id="soal"></span> !-->
            ...
            <span class="flex-abu hidden-xs">Waktu</span>            
            </div>
        </li>
