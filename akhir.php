...
<div class="group hidden-xs">
    <div class="left hidden-xs" style="background-color:<?php echo "$r[XWarna]"; ?>"><a href="#"><img src="images/<?php echo "$r[XBanner]"; ?>" style=" margin-top:10px; width:350px"></a>
    </div>
    	<div class="right"><table width="100%" border="0" style="margin-top:10px">   
						...
						<td><span  style=" margin-left:0px; margin-top:5px">Terima Kasih</span></td></tr>
