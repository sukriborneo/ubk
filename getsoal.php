...
$str = str_replace("'<","`<",$str);
	...
	echo "<img src='pictures/$result[XGambarTanya]' widht='150px'></a><br /><br />";}
	echo "</p>";
                        ...
                        <div class="panel-body">
                            <div class="inner-content">
                                <div class="row" style="background-color:#fff">
                                   ...
                                   echo "<img src='pictures/$pilgbrA' width='30%'></a><br />"; 
                                   }
                                   ?>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="inner-content">
                                <div class="row" style="background-color:#fff">
                                   ...
                                   echo "<img src='pictures/$pilgbrB' width='30%'></a><br />"; 
                                   }
                                   ?>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="inner-content">
                                <div class="row" style="background-color:#fff">
                                   ...
                                   echo "<img src='pictures/$pilgbrC' width='30%'></a><br />"; 
                                   }
                                   ?>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="inner-content">
                                        <div class="row" style="background-color:#fff">
                                           ...
                                           echo "<img src='pictures/$pilgbrD' width='30%'></a><br />"; 
                                           }
                                           ?>
                                        </div>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="inner-content">
                                <div class="row" style="background-color:#fff">
                                   ...
                                   echo "<img src='pictures/$pilgbrE' width='30%'></a><br />"; 
                                   }
                                   ?>
                                </div>
                            </div>
                ...
                <div class="panel-body">
                    <div class="inner-content">
                        <div class="row" style="background-color:#fff">
						   ...
						   //echo "<img src='pictures/$result[XGambarTanya]' height='50%'></a><br />"; 
						   }
						   ?>
                        </div>
                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="" id="imagepreview" style="width: 600px; height: 264px;" >
      </div>
